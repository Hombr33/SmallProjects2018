...
{
    /// <summary>
    /// Interaction logic for ClientRegistrator.xaml
    /// </summary>
    public partial class ClientRegistrator : Window
    {
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            string clientName = this.uiNameTB.Text;
            float clientBudget = Convert.ToSingle(this.uiBudgetTB.Text);
            int clientId = mainService.GetCount("Client") + 1;
            Client client = new Client(clientId, clientName, clientBudget);
